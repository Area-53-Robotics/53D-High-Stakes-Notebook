...
#grid(
  [
    ...
    - Problem: The team had some difficulties placing the gears for the redirect mechanism. The input links for the four-bar got in the way.
    - Solution: We attached the 7x1x1 C-channel in the side with high strength bearings and high strength axles running through it. This is where the gear and motors will be.
   ...
   stack(
    spacing: 15pt,
    figure(
      image("build/2024.10.11-2.png", width: 160pt), 
    ...
    figure(
      image("build/2024.10.11-3.png", width: 160pt),
      caption: "The 15x1x1 C-channel link."
      )
  ),

  figure(
    image("build/2024.10.11-4.jpg", width: 160pt),
...
#colbreak()
 ...
 stack( 
  ...
  [
    === Assembly
      - Problem: The rings were having a hard time getting redirected onto the redirect mechanism. 
      - Solution: We cut 2” by 4” polycarbonate flaps for the redirect mechanism
  ...
  stack(
    spacing: 50pt,
    figure(
      image("build/2024.10.17-2.png", width: 160pt), 
      caption: "The new basket for our redirect mechanism."
      ),

    figure(
      image("build/2024.10.17-3.png", width: 160pt),
