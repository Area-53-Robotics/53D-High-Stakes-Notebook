...
#to-do(
  ...
  (
    ...
    (true, "Select the best ladybrown idea using a decision matrix.", "Everyone"),
    (true, "Plan the implementation of the ladybrown idea.", "Everyone"),
  )
)
...
#pro-con(
  ...
  pros: [
    - *Stability* - Since the ladybrown supports are close to the robot's center of gravity, the ladybrown is stable.
...
#pro-con(
  ...
  cons: [
    - *Arm Length* - This version of the ladybrown has a shorter arm length. This would require us to be closer to the wall stakes for scoring.
