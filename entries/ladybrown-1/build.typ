...
#grid(
  ...
  [
    === Materials
    - 2x 11x1x1 C-channel
    - 12x1x12x 33x2x1 C-channel
    - 12x1x12x Custom Gussets
    - 12x1x12x 5x1x1 C-channel 
    - 12x1x12x 2x1x1 C-channel 
    - 12x1x1The rest of the materials can be found in our toolbox.
...
#grid(
  figure(
    image("build/24-11-1-3.png", width: 170pt),
