...
From our previous observations in our [Identify speedway observations] and [Identify sugar rush observations], we saw that many teams had a mobile goal rush mechanism. This mechanism is useful during auton because it allows us to have early control of a positive corner, and useful during driver control to clear positive and negative corners.
