...
#tournament-match(
  ...
  strategy: [
    ...
    - Then we would switch places with 5588B when they gathered a full mobile goal.
  ],
  auton_notes: [
...
#box[
  ...
  #subsystem-analysis(
    reflection: [
      There was some friction on the left side of our drivetrain. Additionally, we experienced overheating in several of our qualification matches. We will most likely need to repair our intake 
    ],
    radius: 3,
    overperformed: 1,
    satisfactory: 6,
...
#box[
  ...
  #subsystem-analysis(
    reflection: [
      The clamp only worked if it clamped a mobile goal at an angle. If the mobile goal was at its side, then the clamp would clamp too far, causing our intake to overshoot the rings. 
    ],
    radius: 3,
    overperformed: 0,
    satisfactory: 3,
...
#box[
  ...
  #subsystem-analysis(
    reflection: [
      We noticed that from our (Missing entry reference) the intake could score onto the mobile goal perfectly in a vacuum. However, our intake struggled to collect rings during a real match and would frequently jam. 
    ],
    radius: 3,
