...
#tournament-match(
  ...
  auton_notes: [
    - Our auton didn’t score any rings.
  ...
  match_notes: [
    ...
    - 929T score on the wall stakes but we had our team member guard the wall stakes.
    - 929T’s enemy alliance couldn’t score well because they had a 2 motor drivetrain.
...
#tournament-match(
  ...
  awp: false,
  strategy: [
    - Since we weren’t confident with our intaking ability, we planned on playing more defensive.
  ...
  match_notes: [
    ...
    - While we were intaking rings, our intake jammed. We were only able to score 4 rings. 
