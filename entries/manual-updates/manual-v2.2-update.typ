...
#table(
  ...
  [
    A tipped mobile goal would not have its points doubled by a positive corner because it would not count as scored. This is also true for negative corners.
  ],
)
