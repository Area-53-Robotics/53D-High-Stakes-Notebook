...
#grid(
  stack(
    ...
    stack(
      spacing: 5pt,
     figure(
    image("build/intake.11.1-1.png", width: 100pt),
    caption: "Intake stage 1 structure."
  ),
   figure(
    image("build/intake.11.1-2.png", width: 120pt),
    caption: "1st stage intake with flex wheels added."
  ),
    ),
...
#grid(
  [
    ...
    - Polycarbonate 
    - Chain
    - The rest of the materials can be in the toolbox 

  ],
  figure(
    image("build/intake.11.2-1.jpg", width: 120pt), 
...
#grid(
  ...
  [
    === Assembly
    - The first stage of the intake is attached by screw joints. 
  ...
  figure(
    image("build/intake.11.2-2.png", height: 140pt),
    caption: "The intake first stage after mounting"
  ),
...
#grid(
  ...
  figure(
    image("build/intake.11.8-3.jpg", height: 140pt),
