...
#table(
  ...
  table.cell[
    #figure(
      image("identify-minnesota-sig/minnesota-picture-1.jpg"),
  ...
  table.cell[
    #image("identify-minnesota-sig/minnesota-picture-2.jpg", width: 170pt)
  ],
  table.cell[
  ...
  table.cell[
    #figure(
      [
        #image("identify-minnesota-sig/minnesota-picture-3.jpg", width: 180pt)
        #image("identify-minnesota-sig/minnesota-picture-4.jpg", width: 180pt)
      ],
  ...
  table.cell[
    #figure(
      [
        #image("identify-minnesota-sig/minnesota-picture-5.jpg", width: 165pt)
        #image("identify-minnesota-sig/minnesota-picture-6.jpg", width: 170pt)
      ],
      caption: "From their Pits & Parts interview"
    )
  ],
...
#table(
  ...
  table.cell[
    #figure(
      image("identify-minnesota-sig/minnesota-picture-7.jpg"),
      caption: "Round 1-16"
    )
  ],
  table.cell[
  ...
  table.cell[
    #figure(
      image("identify-minnesota-sig/minnesota-picture-8.jpg"),
  ...
  table.cell[
    #figure(
      image("identify-minnesota-sig/minnesota-picture-9.jpg"),
      caption: "Pits & Parts interview"
    )
  ],
  table.cell[
  ...
  table.cell[
    #figure(
      image("identify-minnesota-sig/minnesota-picture-10.jpg"),
      caption: "Pre-Minnesota Signature Event reveal"
    )
    #figure(
      [
        #image("identify-minnesota-sig/minnesota-picture-11.jpg")
        #image("identify-minnesota-sig/minnesota-picture-12.jpg")
      ],
      caption: "Pits & Parts interview"
    )
  ],
...
#table(
  ...
  table.cell[
    #figure(
      image("identify-minnesota-sig/minnesota-picture-13.jpg"),
  ...
  table.cell[
    #figure(
      image("identify-minnesota-sig/minnesota-picture-14.jpg"),
  ...
  table.cell[
    #figure(
      image("identify-minnesota-sig/minnesota-picture-15.jpg"),
      caption: "Pre-season reveal video"
    )
  ],
  table.cell[
...
#table(
  ...
  table.cell[
    #figure(
      image("identify-minnesota-sig/minnesota-picture-16.jpg"),
  ...
  table.cell[
    #figure(
      image("identify-minnesota-sig/minnesota-picture-17.jpg"),
  ...
  table.cell[
    #figure(
      [
        #image("identify-minnesota-sig/minnesota-picture-18.jpg")
        #image("identify-minnesota-sig/minnesota-picture-19.jpg")
      ],
      caption: "Pre-season reveal"
    )
  ],
