#import "/packages.typ": *
#import components: *
#import icon-format: nb_icon
#import page: *
#import tablex: *
#import codetastic: *
#import "/delta/icons/icons.typ": * // Might need to find a better import mechanism
...
Typst gives us multiple benefits compared to Google Slides and other platforms:
...
#box(baseline: 12.5%)[
  #box(
    image("/delta/tabler-icons/brand-github-filled.svg", height: 1em),
    baseline: 10%
    )
